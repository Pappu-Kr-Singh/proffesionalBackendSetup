...
const upadateUserCoverImage = asyncHandler(async(req, res) =>{
  ...
  if(!coverImage.url) {
    throw new ApiError(400, "error while uploding coverImage on the cloudinary")
  }
...
return res
.status(200)
.json(new ApiResponce(200, user[0].watchHistory, "Watch history fetched successullly!!"))
